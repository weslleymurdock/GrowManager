...
using GrowManager.Client.Infrastructure.Managers.Identity.Roles;
using GrowManager.Client.Infrastructure.Mappings;
...
using Permissions = GrowManager.Shared.Constants.Permission.Permissions;
...
namespace Client.App.Pages.Identity
{
    public partial class RolePermissions 
    {
        ...
        private MudBlazor.Color GetGroupBadgeColor(int selected, int all)
        {
            if (selected == 0)
