...
using GrowManager.Client.Infrastructure.Managers.Catalog.Brand;
using GrowManager.Client.Infrastructure.Managers.Catalog.Product;
...
namespace Client.App.Pages.Catalog
{
    public partial class AddEditProductModal
    {
        ...
        private async Task UploadFiles(InputFileChangeEventArgs e)
        {
            ...
            if (_file != null)
            {
                ...
                AddEditProductModel.UploadRequest = new UploadRequest { Data = buffer, UploadType = GrowManager.Application.Enums.UploadType.Product, Extension = extension };
            }
        }
