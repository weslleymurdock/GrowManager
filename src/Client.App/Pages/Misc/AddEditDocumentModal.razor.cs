...
using GrowManager.Client.Infrastructure.Managers.Misc.Document;
using GrowManager.Client.Infrastructure.Managers.Misc.DocumentType;
...
namespace Client.App.Pages.Misc
{
    public partial class AddEditDocumentModal
    {
        ...
        private async Task UploadFiles(InputFileChangeEventArgs e)
        {
            ...
            if (_file != null)
            {
                ...
                AddEditDocumentModel.UploadRequest = new UploadRequest { Data = buffer, UploadType = GrowManager.Application.Enums.UploadType.Document, Extension = extension };
            }
        }
