...
using GrowManager.Client.Infrastructure.Managers.Communication;
...
namespace Client.App.Pages.Communication
{
    public partial class Chat
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var user = state.User;
            CurrentUserId = user.GetUserId();
            ClientPreference preference = await _localStorage.GetItemAsync<ClientPreference>(x => x.Preference == StorageConstants.Local.UserImageURL);
            CurrentUserImageURL = preference.UserImageURL;
        ...
        private MudBlazor.Color GetUserStatusBadgeColor(bool isOnline)
        {
            switch (isOnline)
            {
                case false:
